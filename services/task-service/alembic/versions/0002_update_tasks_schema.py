...
def upgrade() -> None:
    ...
    op.add_column("tasks", sa.Column("payload", JSONB(), nullable=False, server_default="{}"))
...
def downgrade() -> None:
    ...
    op.add_column("tasks", sa.Column("input_url", sa.String(), nullable=False, server_default=""))
